...
import com.example.agc_inventory.adapter.ViewPagerAdapter;
import com.example.agc_inventory.fragment.KeyDwonFragment;
import com.example.agc_inventory.tools.UIHelper;
import com.example.agc_inventory.widget.NoScrollViewPager;
...
public class BaseTabFragmentActivity extends FragmentActivity {
	...
	private final int offscreenPage = 1; //����ViewPager���ڵļ���ҳ��
	...
	private ActionBar.Tab tab_read, tab_kill, tab_lock, tab_set ;
	...
	public void initUHF() {
		...
		mActionBar = getActionBar();					//取得 Activity 的 ActionBar
		mActionBar.setDisplayShowTitleEnabled(true);	//是否顯示標題
...
//		tab_read = mActionBar.newTab().setText(mViewPagerAdapter.getPageTitle(2)).setTabListener(mTabListener);
...
//        mActionBar.addTab(mActionBar.newTab().setText(getString(R.string.myMenu)).setTabListener(mTabListener));
	...
	protected ActionBar.TabListener mTabListener = new ActionBar.TabListener() {
		...
		public void onTabSelected(ActionBar.Tab tab, android.app.FragmentTransaction fragmentTransaction) {
			if (mActionBar.getTabCount() > 2 && tab.getPosition() != 2) {
				mActionBar.removeTabAt(2);
			}
	...
	public void getUHFVersion() {
		if(mReader!=null) {
			...
			UIHelper.alert(this, R.string.action_uhf_ver,
					"Software:20200724 v1.0 \n"  + "UHF:" + rfidVer, R.drawable.webtext);
		}
	}
